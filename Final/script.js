...
async function verificarVencedor() {
    ...
    if (((a1 === b1 && a1 === c1) || (a1 === a2 && a1 === a3) || (a1 === b2 && a1 === c3 && a1)) && a1 != "") {
        vencedor = a1;

    } else if ((b2 === a2 && b2 === c2 && b2 != "") || (b2 === b1 && b2 === b3 && b2 != "") || (b2 === a3 && b2 === c1 && b2 != "")) {
        vencedor = b2
    ...
    if (vencedor != "" ) {
        ...
        alert(`THE WINNER IS ${vencedor}`);

    } else if (vencedor == "" && velha == 9) {
...
//Detalhes do Código: função principal assíncrona e função sleep para rodar o alert após a renderização do html 